    ...
    public function run(): void
    {
        $fields = [
            ...
            'wedding' => [
                ...
                ['field_key' => 'groom_child_order', 'field_label' => 'Anak ke-', 'field_type' => 'text', 'is_required' => false, 'display_order' => 3, 'placeholder' => 'cth. Anak pertama'],
                ['field_key' => 'groom_photo', 'field_label' => 'Foto Pengantin Pria', 'field_type' => 'file', 'is_required' => true, 'display_order' => 4],
                ['field_key' => 'groom_father', 'field_label' => 'Nama Ayah Pengantin Pria', 'field_type' => 'text', 'is_required' => false, 'display_order' => 5],
                ['field_key' => 'groom_mother', 'field_label' => 'Nama Ibu Pengantin Pria', 'field_type' => 'text', 'is_required' => false, 'display_order' => 6],
                ['field_key' => 'groom_instagram', 'field_label' => 'Instagram Pengantin Pria', 'field_type' => 'text', 'is_required' => false, 'display_order' => 7],
                ['field_key' => 'bride_name', 'field_label' => 'Nama Pengantin Wanita', 'field_type' => 'text', 'is_required' => true, 'display_order' => 8],
                ['field_key' => 'bride_nickname', 'field_label' => 'Nama Panggilan Pengantin Wanita', 'field_type' => 'text', 'is_required' => false, 'display_order' => 9],
                ['field_key' => 'bride_child_order', 'field_label' => 'Anak ke-', 'field_type' => 'text', 'is_required' => false, 'display_order' => 10, 'placeholder' => 'cth. Anak kedua'],
                ['field_key' => 'bride_photo', 'field_label' => 'Foto Pengantin Wanita', 'field_type' => 'file', 'is_required' => true, 'display_order' => 11],
                ['field_key' => 'bride_father', 'field_label' => 'Nama Ayah Pengantin Wanita', 'field_type' => 'text', 'is_required' => false, 'display_order' => 12],
                ['field_key' => 'bride_mother', 'field_label' => 'Nama Ibu Pengantin Wanita', 'field_type' => 'text', 'is_required' => false, 'display_order' => 13],
                ['field_key' => 'bride_instagram', 'field_label' => 'Instagram Pengantin Wanita', 'field_type' => 'text', 'is_required' => false, 'display_order' => 14],
                ['field_key' => 'couple_photo', 'field_label' => 'Foto Bersama', 'field_type' => 'file', 'is_required' => false, 'display_order' => 15],
                ['field_key' => 'opening_quote', 'field_label' => 'Kutipan Pembuka', 'field_type' => 'textarea', 'is_required' => false, 'display_order' => 16],
            ],
